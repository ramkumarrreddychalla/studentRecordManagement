package com.msis.webapp.controller;
...
import com.msis.webapp.service.UserProfileService;
import com.msis.webapp.service.UserService;
...
public class AppController {
     ...
     */
    @RequestMapping(value = { "/info-user-{loggedinuser}" }, method = RequestMethod.GET)
     ...
     */
    @RequestMapping(value = { "/info-user-{ssoId}" }, method = RequestMethod.POST)
    public String updateinfoUser(@Valid User user, BindingResult result,
